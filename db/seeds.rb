...
Item.create!(title: "Christmas Socks", description: "Great wollen christmas socks, super comfortable and keep you nice and warm", brand: "Santa's socks", user: user_new)
Item.create!(title: "Hertha Berlin Shirt", description: "This is a official signed hertha shirt with the entire team having signed it", brand: "Nike", user: user_new)
Item.create!(title: "grass skirt", description: "grass skirt made out of native plants to the pacific", brand: "Homemade", user: user_new)
Item.create!(title: "Overalls", description: "Used overalls, lots of paint marks, good if you need to do some work around the house", brand: "Levis", user: user_new)
# ]
